    ...
    ; 2. Пишем в Slot 2 ------------------------------- 
    ld a, 0x0B        ; Bank0:3, Bank1:1
    out (0xFA), a
    
    ld a, 0           ; Та же страница 0
    out (0xFD), a
    
    ld a, 0xA2        ; Метка для слота 1
    ld (0x7FFF), a

    ; 2. Пишем в Slot 3 ------------------------------- 
    ld a, 0x0F        ; Bank0:3, Bank1:1
    out (0xFA), a
    
    ld a, 0           ; Та же страница 0
    out (0xFD), a
    
    ld a, 0xA3        ; Метка для слота 1
    ld (0x7FFF), a
