...
Первая страница MMIO_LO (Page 0, адреса `FF0000h - FF7FFFh`) содержит самые необходимые системные устройства, размещенные с шагом в 32 байта для выравнивания и простоты декодирования адресов:
