Отлично! Внесём изменения в документацию, сохранив всю ключевую информацию. Вот обновлённая версия с учётом ваших правок:
...
*   **`GLOBAL_CTRL` (Port `F0h`)**: Главный регистр управления режимами.
    ...
    |-----|------------|------------------------------------------------------------------------------------------------------------------------|
    | 0   | Functional | **supervisor_mode**: 1=Режим супервизора (устанавливается аппаратно или программно).                                   |
