...
|-------|----------|-----|----------|
| 0x00 | **CTRL_ACTION** | R/W | Регистр одноразовых действий |
| 0x01 | **CTRL_MODE** | R/W | Регистр режимов работы |
...
#### Регистр CTRL_ACTION (0x00) - одноразовые действия
...
#### Регистр CTRL_MODE (0x01) - режимы работы

| Бит | Название | Описание |
|-----|----------|----------|
| 0 | **STEP_EN** | 1 = Включить пошаговый режим |
| 1-7 | **RESERVED** | Резерв |
...
send([0x30, 0x01, 0x01])  # REG_WRITE(CTRL_MODE, 0x01=STEP_EN)
...
while True:
    ...
    if status & 0x04:  # Бит CPU_STOPPED
        break
