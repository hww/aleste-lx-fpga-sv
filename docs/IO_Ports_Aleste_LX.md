...
Для совместимотси с legacy устройствами поодержиавется Legacy режим, а для нового ПО нативный Nayive режим. В 24 битном адресном простренсве роазсположены 4 слота. Оследний слот SL3 в последней странице памяти имеет 64 KB область MMIO разбитую на две части MMIO_HI и MMIO_LO.
...
| Device / Description                       | RW | Legacy IO Address | Legacy Wishbone Address | Native IO Address | Native Wishbone Address |
|--------------------------------------------|----|-------------------|-------------------------|-------------------|-------------------------|
