...
module hdmi_scaler_core #(
    ...
    // Параметры выходного видео (стандарт HDMI 720p)
    parameter int DST_WIDTH        = 1280,     // Активная ширина выходного изображения
    parameter int DST_HEIGHT       = 720,      // Активная высота выходного изображения
    parameter int DST_TOTAL_WIDTH  = 1650,     // Общая ширина строки (активная + бланкинг)
    parameter int DST_TOTAL_HEIGHT = 750,      // Общая высота кадра (активная + бланкинг)
    parameter int DST_HSYNC_START  = 1280 + 110,  // Начало горизонтальной синхронизации
    parameter int DST_HSYNC_END    = DST_HSYNC_START + 40,  // Конец горизонтальной синхронизации
    parameter int DST_VSYNC_START  = 720 + 5,  // Начало вертикальной синхронизации
    ...
    input  logic src_pixel_valid_i,            // Валидность входного пикселя
    ...
    output logic dst_pixel_valid_o,            // Валидность выходного пикселя
    ...
    logic dst_pixel_valid_pre;                 // Предварительный сигнал валидности пикселя
    ...
    assign dst_pixel_data_o = dst_buf_ready[dst_buf_sel] ? 
                             ...
                             24'h000000;  // Черный цвет при отсутствии данных
