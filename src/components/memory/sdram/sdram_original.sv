...
#(
    ...
    parameter [4:0]   T_RP = 5'd1,     // 15ns, precharge to active
    parameter [4:0]   T_RCD= 5'd1,     // 15ns, active to r/w
    parameter [4:0]   T_RC = 5'd4,      // 60ns, ref/active to ref/active
