...
module aleste_video #(
    ...
    // Wishbone Signals
    logic wb_ext_cyc, wb_ext_stb, wb_ext_ack, wb_ext_we;
    logic [23:0] wb_ext_adr;
    logic [15:0] wb_ext_dat_i, wb_ext_dat_o;
    logic [1:0] wb_ext_sel, wb_ext_tag;

    logic palette_cyc, palette_stb, palette_ack, palette_we;
    logic [15:0] palette_adr, palette_dat_i, palette_dat_o;
    logic [1:0] palette_sel;

    logic crtc_cyc, crtc_stb, crtc_ack, crtc_we;
    logic [15:0] crtc_adr, crtc_dat_i, crtc_dat_o;
    logic [1:0] crtc_sel;
    logic crtc_sel_o; // CRTC self-detection signal

    logic mem_cyc, mem_stb, mem_ack, mem_we;
    logic [23:0] mem_adr;
    ...
    mc6845mod #(
        ...
        .crtc_bpp_mode(crtc_bpp_mode),
        .crtc_continuous_mode(crtc_continuous_mode),
        .crtc_use_cpc_modes(crtc_use_cpc_modes),
        
        // Extended address interface
        .crtc_burst_mode_o(crtc_burst_mode),
        .crtc_addr_mode_o(crtc_addr_mode),
        .crtc_pixel_clock_sel_o(crtc_pixel_clock_sel)
    );
