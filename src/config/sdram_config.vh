// src/config/sdram_config.vh
`ifndef SDRAM_CONFIG_VH
`define SDRAM_CONFIG_VH
...
// Timing in clock cycles (для 100MHz)
`define SDRAM_T_RC_CYCLES    6
`define SDRAM_T_RAS_CYCLES   5
`define SDRAM_T_RCD_CYCLES   2
`define SDRAM_T_RP_CYCLES    2
`define SDRAM_T_WR_CYCLES    2

`endif // SDRAM_CONFIG_VH