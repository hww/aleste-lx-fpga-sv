...
void Vtb_z80___024root___eval_triggers__act(Vtb_z80___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->tb_z80__DOT__dut__DOT__ctl_state_alu) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__ctl_state_alu__1)));
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->tb_z80__DOT__dut__DOT__db0) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__db0__1)));
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->tb_z80__DOT__dut__DOT__db2) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__db2__1)));
    vlSelf->__VactTriggered.set(3U, ((IData)(vlSelf->tb_z80__DOT__dut__DOT__db_hi_as) 
                                     != (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__db_hi_as__1)));
    vlSelf->__VactTriggered.set(4U, ((IData)(vlSelf->tb_z80__DOT__dut__DOT__reg_file___DOT__gdfx_temp0) 
    ...
    vlSelf->__VactTriggered.set(7U, (((IData)(vlSelf->CLK) 
                                     ...
                                     | ((~ (IData)(vlSelf->tb_z80__DOT__dut__DOT__nreset)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__nreset__0))));
    vlSelf->__VactTriggered.set(8U, (((~ (IData)(vlSelf->tb_z80__DOT__dut__DOT__interrupts___DOT__SYNTHESIZED_WIRE_9)) 
    ...
    vlSelf->__VactTriggered.set(0xcU, ((~ (IData)(vlSelf->CLK)) 
                                       & (IData)(vlSelf->__Vtrigprevexpr___TOP__CLK__0)));
    vlSelf->__VactTriggered.set(0xdU, (((IData)(vlSelf->CLK) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__CLK__0))) 
                                       | ((~ (IData)(vlSelf->tb_z80__DOT__dut__DOT__resets___DOT__SYNTHESIZED_WIRE_8)) 
                                          & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_z80__DOT__dut__DOT__resets___DOT__SYNTHESIZED_WIRE_8__0))));
