...
ay8912_vtable:
    dw ay_base_init          ; init
    dw ay_base_play_note     ; play_note
    dw ay_base_set_register  ; set_register
    dw ay_base_get_register  ; get_register
    dw ay_base_stop          ; stop
    dw ay_base_pause         ; pause
    dw ay_base_resume        ; resume
    dw ay_base_set_volume    ; set_volume
    dw ay_base_start_playback; start_playback
    dw ay8912_detect         ; detect (СВОЙ метод!)
