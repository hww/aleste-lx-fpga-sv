...
@set_volume:
    ...
    pop hl
    push hl
    ld a, l  ; Громкость из входа (в L после push/pop)
    and 0x0F
    call ay_base_set_register
...
; ----------------------------------------------------------------------------
; ay_base_note_to_freq - Преобразовать ноту в частоту (A=нота, выход HL)
; ----------------------------------------------------------------------------
ay_base_note_to_freq:
    push bc
